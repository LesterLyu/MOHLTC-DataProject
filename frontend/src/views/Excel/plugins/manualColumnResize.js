...
const {BasePlugin} = Handsontable.plugins;
const {addClass, hasClass, removeClass, outerHeight, pageX} = Handsontable.dom;
const {arrayEach, rangeEach} = Handsontable.helper;
 ...
 *
 * @plugin ManualColumnResize2
 */
export class ManualColumnResize2 extends BasePlugin {
   ...
   */
  isEnabled() {
    return this.hot.getSettings().manualColumnResize2;
  }
  ...
  enablePlugin() {
    ...
    this.manualColumnWidths = [];
    const initialColumnWidth = this.hot.getSettings().manualColumnResize2;
  ...
  onModifyColWidth(width, column) {
    ...
    if (this.enabled) {
      ...
      if (this.hot.getSettings().manualColumnResize2 && columnWidth) {
