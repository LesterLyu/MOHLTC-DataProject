...
function getSelected() {
  ...
  data.push(['', ''].concat(att)); // add columns
  ...
  for (i = 0; i < selected_categories.length; i++) {
    ...
    data.push([cat_id, cat].concat(Array(selected_attributes.length).join('.').split('.')));
  }
...
$('#preview-btn').click(function () {
  ...
  previewTable.loadData(getSelected()); // lock all cells
...
//# sourceMappingURL=createWorkbook.js.map
