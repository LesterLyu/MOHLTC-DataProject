    ...
    $.ajax({
        ...
        if(response.success) {
            ...
            for (var i = 0; i < workbooks.length; i++) {
                ...
                container.append('<a href="/new/fill-workbook/' + name + '" class="btn btn-outline-secondary form-name-box mr-2">\n' +
    ...
    $.ajax({
        ...
        if(response.success) {
            ...
            for (var i = 0; i < filledWorkbooks.length; i++) {
                ...
                container.append('<a href="/new/edit-workbook/' + name + '" class="btn btn-outline-secondary form-name-box mr-2">\n' +
