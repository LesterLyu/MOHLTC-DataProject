  ...
  $('#user-table').DataTable({
    ...
    columnDefs: [{
      render: function render(data, type, row) {
        var newPer = $('<select></select>').addClass('selectpicker').attr('multiple', 'multiple').attr('id', 'select-' + row.username).attr('data-style', 'btn-outline-primary').attr('data-live-search', 'true');
      ...
      render: function render(data, type, row) {
        var div = $('<div></div>').addClass('btn-group btn-group-toggle').attr('data-toggle', 'buttons').attr('id', 'radios-' + row.username);
